        ...
        <div class="container">
            <div class="slider-container has-scrollbar">
                <div class="slider-item">
                    <img src="{{ asset('images') }}/banner/1.webp" alt="banner 1" class="banner-img">
                </div>
                <div class="slider-item">
                    <img src="{{ asset('images') }}/banner/2.webp" alt="banner 2" class="banner-img">
                </div>
                <div class="slider-item">
                    <img src="{{ asset('images') }}/banner/3.webp" alt="banner 3" class="banner-img">
                </div>
            </div>
        </div>
    </div>
                ...
                @foreach ($categories as $category)
                    <div class="category-item">
                        <div class="category-img-box">
                            ...
                            @else
                                <img src="{{ asset('images/category').'/category.webp' }}" alt="{{ $category->name }}" width="30">
                            @endif
                        </div>
