    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{ route('admin.products.create') }}" class="btn btn-success btn-sm">{{ trans('global.add')." ".$title }}</a>
            </div>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ asset('images/product') . "/" . $dt->thumbnail }}" target="_blank" rel="noopener noreferrer">
                                <img src="{{ asset('images/product') . "/" . $dt->thumbnail }}" class="img-fluid rounded-start w-25" alt="Thumbnail">
                            </a>
                        </td>
